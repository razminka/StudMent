class Student:
    ...
    def __gt__(self, other):
        if not isinstance(other, Student):
            print('Сравниваю объекты разных классов')
            return
...
student_2 = Student('Stas', 'Markeloff', 'your_gender')
...
mentor_reviewer_1.rate_hw_student(student_1, 'Python', 4)
mentor_reviewer_1.rate_hw_student(student_1, 'Git', 10)
mentor_reviewer_1.rate_hw_student(student_1, 'Django', 5)

mentor_reviewer_1.rate_hw_student(student_2, 'Python', 7)
mentor_reviewer_1.rate_hw_student(student_2, 'Python', 10)
mentor_reviewer_1.rate_hw_student(student_2, 'Python', 5)
mentor_reviewer_1.rate_hw_student(student_2, 'Git', 10)
mentor_reviewer_1.rate_hw_student(student_2, 'Django', 6)

student_1.rate_hw_lecturer(mentor_lecturer_1, 'Python', 10)
student_1.rate_hw_lecturer(mentor_lecturer_1, 'Python', 5)
